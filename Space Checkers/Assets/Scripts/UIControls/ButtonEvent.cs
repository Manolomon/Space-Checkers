...
public class ButtonEvent : MonoBehaviour {
    ...
    /// </summary>
    public void ClickInvite()     {         InputField invitado = GameObject.Find("/Canvas/InvitationPanel/TFEmail").GetComponent<InputField>();         Debug.Log("Invitation to: " + invitado.text);
